                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="mb-4 flex justify-between items-center">
                        ...
                        <a href="{{ route('places.index') }}"
                            class="bg-gray-500 hover:bg-gray-600 text-white py-2 px-4 rounded"><i class="fi fi-br-enter"></i></a>
                    </div>
                                ...
                                <a href="{{ route('places.show', $place)}}">
                                    ...
                                    <div
                                        ...
                                        <form method="POST" action="{{ route('places.unfavorite', $place) }}">
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                class="bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded"><i
                                                    class="fi fi-br-x"></i> 
                                                </i>Quitar
                                                Favorito</button>
                                        </form>
